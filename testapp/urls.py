...
urlpatterns = [
    ...
    path('api/tests/<test_id>/stats/', views.api_get_test_stats, name='api_get_test_stats'),
    path('api/tests/<test_id>/duplicate/', views.api_duplicate_test, name='api_duplicate_test'),
    path('api/tests/<test_id>/live-results/', views.api_live_results, name='api_live_results'),
